            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-6">
              ...
              {mpesaType === "Paybill" && (
                <label className="block">
                  ...
                  <p className="mt-0.5 text-xs text-[#6b6b70]">
                    The account reference buyers enter when paying e.g. your business name or order number.
                  </p>
                  <input
                    value={accountName}
              ...
              <div className="rounded-[14px] border border-[#ececec] bg-[#fafafa] px-4 py-3 text-xs text-[#6b6b70]">
                {mpesaType === "Till" ? (
                  <>
                    <span className="font-bold text-[#0f0f10]">Till payment flow: </span>
                    Buyer opens M-Pesa → Lipa na M-Pesa → Buy goods → enters your Till number → pays.
                  </>
                ) : (
                  <>
                    <span className="font-bold text-[#0f0f10]">Paybill payment flow: </span>
                    Buyer opens M-Pesa → Lipa na M-Pesa → Paybill → enters your Paybill number → enters account name → pays.
                  </>
                )}
              </div>
