const API_BASE_URL = (process.env.NEXT_PUBLIC_API_URL ? process.env.NEXT_PUBLIC_API_URL.replace(/\/$/, '') : 'https://etikketapi.quickzingo.co.ke') + '/api';

/** Returns the public backend base URL (without /api) for static assets like images */
export const BACKEND_URL = process.env.NEXT_PUBLIC_API_URL
  ? process.env.NEXT_PUBLIC_API_URL.replace(/\/$/, '')
  : 'https://etikketapi.quickzingo.co.ke';
